...
// orbitsList.forEach(orbit => {
//   const [primary, moon] = orbit.split(")");
//   if (primary in orbitsHash) {
//     orbitsHash[primary].push(moon);
//   } else {
//     orbitsHash[primary] = [moon];
//   }
// });
// let totalOrbits = 0;
// for (const primary in orbitsHash) {
//   totalOrbits += getOrbitNumbers(primary, orbitsHash);
// }
// console.log(totalOrbits);
// function getOrbitNumbers(primary, orbitsHash) {
//   if (primary in orbitsNum) {
//     return orbitsNum[primary];
//   }
//   if (primary in orbitsHash) {
//     const orbits = orbitsHash[primary];
//     const numOrbits =
//       orbits.length +
//       orbits.reduce((acc, moon) => acc + getOrbitNumbers(moon, orbitsHash), 0);
//     orbitsNum[primary] = numOrbits;
//     return numOrbits;
//   }
//   orbitsNum[primary] = 0;
//   return 0;
