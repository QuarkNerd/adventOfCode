...
let relativeBase = 0;
const CHALLENGE_NUMBER = 1; // set to 2 for part 2
computeAlarm(intcode);
  ...
  while (i < C.length) {
    ...
    switch (opcode) {
      ...
      case 2:
        ...
        break;
      case 3:
        setValue(C, CHALLENGE_NUMBER, i + 1, parameterModes[1]);
        i += 2;
        break;
      case 4:
        console.log(getValue(C, i + 1, parameterModes[1]));
        i += 2;
        break;
      case 5:
